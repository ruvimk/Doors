...
;; .....  
stg3_int_table: 
	dd stg3_fxn_names.SetGDTdesc 
	dd SetGDTdesc 
	dd 7 
	dd 0 
	
	dd stg3_fxn_names.SetGate 
	dd SetGate 
	dd 7 
	dd 0 
	
	dd stg3_fxn_names.GetMemorySize 
	dd stg3_fxn_extra.GetMemorySize 
	dd 0 
	dd 0 
	
	dd stg3_fxn_names.print 
	dd stg3_fxn_extra.print 
	dd 1 
	dd 0 
	
	dd stg3_fxn_names.putchar 
	dd stg3_fxn_extra.putchar 
	dd 1 
	dd 0 
	
	dd stg3_fxn_names.cls 
	dd stg3_fxn_extra.cls 
	dd 0 
	dd 0 
	
	dd stg3_fxn_names.GetCursor 
	dd stg3_fxn_extra.GetCursor 
	dd 0 
	dd 0 
	
	dd stg3_fxn_names.SetCursor 
	dd stg3_fxn_extra.SetCursor 
	dd 1 
	dd 0 
	
	dd stg3_fxn_names.stg3_fxn 
	dd stg3_fxn 
	dd 3 
	dd 0 
	
	dd stg3_fxn_names.stg3_free_params 
	dd stg3_free_params 
	dd 5 
	dd 0 
	
	dd stg3_fxn_names.StrCmp1 
	dd StrCmp1 
	dd 2 
	dd 0 
	
	dd stg3_fxn_names.MemoryCopy 
	dd MemoryCopy 
	dd 3 
	dd 0 
...
stg3_int: 
	...
	mov ebx, eax 
	add ebx, 14 
	push dword stg3_fxn_names.CallFromUser 
	push dword [ebx] 
	call StrCmp1 
	cmp eax, 0 
	jz .from_user_2 
